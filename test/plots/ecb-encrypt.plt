...
plot 'aes-128-ecb_gpu_cudamrg.dat' using ($2/1048576) title 'AES-128 ECB GPU' with linespoints, \
     'aes-128-ecb_cpu.dat' using ($2/1048576) title 'AES-128 ECB CPU' with linespoints, \
     'bf-ecb_gpu_cudamrg.dat' using ($2/1048576) title 'Blowfish ECB GPU' with linespoints, \
