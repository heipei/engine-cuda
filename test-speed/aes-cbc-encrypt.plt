...
GNUTERM = "wxt"
plot 'aes-128-cbc.dat' using 2 title 'AES 128 CBC GPU' with linespoints,'aes-192-cbc.dat' using 2 title 'AES 192 CBC GPU' with linespoint,'aes-256-cbc.dat' using 2 title 'AES 256 CBC GPU' with linespoint,'aes-128-cbc-cpu.dat' using 2 title 'AES 128 CBC CPU' with linespoints,'aes-192-cbc-cpu.dat' using 2 title 'AES 192 CBC CPU' with linespoint,'aes-256-cbc-cpu.dat' using 2 title 'AES 256 CBC CPU' with linespoint
#    EOF
